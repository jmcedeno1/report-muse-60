...
const themeOptions: { value: Theme; label: string }[] = [
  ...
  { value: "Pilot Projects", label: "Pilot Projects" },
];
    ...
    <section id="references" className="scroll-mt-8">
      ...
      <div className="mt-8 p-4 bg-muted/30 rounded-lg">
        <p className="text-sm text-muted-foreground">
          <strong>Sources:</strong> This report synthesizes information from three primary documents:
        </p>
        <ul className="text-sm text-muted-foreground mt-2 space-y-1">
          <li>• Bidirectional EV Charging Whitepaper</li>
          <li>• EV Bidirectional Charging Report Generation</li>
          <li>• SciSpace Literature Review on EV Bidirectional Charging (49+ peer-reviewed studies)</li>
        </ul>
      </div>
    </section>
  );
