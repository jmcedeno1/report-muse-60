...
export function ImpactSection() {
  return <section id="impact" className="scroll-mt-8">
      <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
        Economic & Environmental Impact
      </h2>

      {/* Economic Impact */}
      <CollapsibleCard title={impactData.economic.title} icon={<DollarSign className="h-5 w-5 text-primary" />} defaultOpen={true} className="mb-6">
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {impactData.economic.barriers.map(barrier => <div key={barrier.barrier} className="border border-border rounded-lg p-3">
      ...
      <CollapsibleCard title={impactData.environmental.title} icon={<Leaf className="h-5 w-5 text-primary" />} className="mb-6">
        <div className="space-y-6">
          {/* Benefits */}
          <div>
            <p className="font-medium text-foreground mb-3">Environmental Benefits</p>
            <div className="grid gap-3">
              {impactData.environmental.benefits.map(benefit => <Card key={benefit.benefit}>
      ...
      {/* Battery Degradation */}
      <CollapsibleCard title={impactData.environmental.batteryDegradation.title} icon={<Battery className="h-5 w-5 text-primary" />}>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                {impactData.environmental.batteryDegradation.factors.map((factor, i) => <li key={i} className="flex items-start gap-2">
            ...
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                {impactData.environmental.batteryDegradation.mitigation.map((item, i) => <li key={i} className="flex items-start gap-2">
